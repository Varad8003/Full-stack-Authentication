...
const ResetPassword = () => {
  ...
  const[isOtpSubmitted,setisOtpSubmitted]=useState(false);
   const inputRefs=React.useRef([]);
    ...
    const onsSubmitNewPassword=async (e)=>{
      e.preventDefault();
      try {
  ...
  {!isEmailSent &&
          <form onSubmit={onSubmitEmail} className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm">
            ...
            <p className="text-center mb-6 text-indigo-300">Enter Your regestired Email-id</p>
...
{!isOtpSubmitted && isEmailSent &&
          <form  onSubmit={ouSubmitOtp} className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm">
...
{isOtpSubmitted && isEmailSent &&
      <form onSubmit={onsSubmitNewPassword} className="bg-slate-900 p-8 rounded-lg shadow-lg w-96 text-sm">
